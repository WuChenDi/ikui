          ...
          <div className="flex flex-col gap-8 text-[0.9375rem] leading-relaxed text-foreground/90 sm:text-base">
            <section className="flex flex-col gap-3">
              ...
              <p>
                ...
                ) is an open-source collection of UI components that you can
                copy and paste into your projects. The components themselves are
                released under the <strong>MIT License</strong>, meaning you are
                free to use, copy, modify, and distribute them in your own
                projects. These terms govern your use of the ikui website and
                its associated services (accounts, sponsorships).
              </p>
            </section>
            ...
            <section className="flex flex-col gap-3">
              ...
              <p>
                Sponsorship of ikui is entirely voluntary. Sponsorships are
              ...
              <p>
                Sponsorship payments are <strong>non-refundable</strong>. You
                may cancel your sponsorship at any time, which will take effect
                at the end of the current billing period. Sponsor benefits (such
                as logo placement) will remain active until the end of the paid
                period.
              </p>
              <p>
            ...
            <section className="flex flex-col gap-3">
              ...
              <p>
                The UI components provided by ikui are licensed under the MIT
                License. You may use them freely in personal and commercial
                projects. The MIT License applies to the component source code
                only. The ikui website, branding, and documentation design are
            ...
            <section className="flex flex-col gap-3">
              ...
              <p>
                ikui is provided <strong>&quot;as is&quot;</strong> and{' '}
            ...
            <section className="flex flex-col gap-3">
              ...
              <p>
                If you have questions about these terms, please reach out on our{' '}
                <Link
