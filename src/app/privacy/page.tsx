          ...
          <div className="flex flex-col gap-8 text-[0.9375rem] leading-relaxed text-foreground/90 sm:text-base">
            <section className="flex flex-col gap-3">
              ...
              <p>
                ...
                copy and paste into your projects. We respect your privacy and
                collect only what is necessary to run the site and its
            ...
            <section className="flex flex-col gap-3">
              ...
              <p>
                ...
                , and <strong>profile image URL</strong>. This information is
                used solely to identify your account on the site.
              </p>
            </section>
            ...
            <section className="flex flex-col gap-3">
              ...
              <p>
                ...
                <strong>user agent</strong> string when you sign in. This data
                is tied to your session and is not used for tracking or
                profiling.
              </p>
            </section>
            ...
            <section className="flex flex-col gap-3">
              ...
              <p>
                ...
                privacy-first analytics service that does not use cookies and
                does not track individual users. It only collects aggregated
                data such as page views, referrers, and browser/device types.
                Learn more:{' '}
                <Link
            ...
            <section className="flex flex-col gap-3">
              ...
              <p>
                ...
                stored in a <strong>Turso</strong> database (SQLite). Data is
                not replicated to third-party services beyond what is described
                in this policy.
              </p>
            </section>
            ...
            <section className="flex flex-col gap-3">
              ...
              <p>
                ...
                service providers mentioned above (Whop for payments, Cloudflare
                for hosting and analytics, Turso for database storage) as
